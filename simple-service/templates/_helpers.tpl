...
{{/*Main annotations*/}}
{{- define "<CHARTNAME>.main.annotations" -}}
...
*/}}
{{- define "<CHARTNAME>.main.podAntiAffinity.soft" -}}
podAntiAffinity:
  preferredDuringSchedulingIgnoredDuringExecution:
    - podAffinityTerm:
        ...
        labelSelector:
          matchLabels:
            {{- include "<CHARTNAME>.main.selectorLabels" . | nindent 12 }}
      weight: 100
{{- end }}
...
*/}}
{{- define "<CHARTNAME>.main.podAntiAffinity.hard" -}}
podAntiAffinity:
  requiredDuringSchedulingIgnoredDuringExecution:
    - topologyKey: kubernetes.io/hostname
      labelSelector:
        matchLabels:
          {{- include "<CHARTNAME>.main.selectorLabels" . | nindent 10 }}
{{- end }}